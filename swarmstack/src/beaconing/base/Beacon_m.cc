...
int BeaconDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "currPosition")==0) return base+5;
    if (fieldName[0]=='c' && strcmp(fieldName, "currVelocity")==0) return base+6;
...
std::string BeaconDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: {std::stringstream out; out << pp->getCurrPosition(); return out.str();}
        case 6: {std::stringstream out; out << pp->getCurrVelocity(); return out.str();}
        default: return "";
    }
}
...
void *BeaconDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: return (void *)(&pp->getCurrPosition()); break;
        case 6: return (void *)(&pp->getCurrVelocity()); break;
        default: return nullptr;
    }
}
